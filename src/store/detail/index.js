...
export default {
    ...
    actions: {
        ...
        async get_Comment_data({ commit, state, rootState }, { page, type }) {
            ...
            let params = {
                'newsDetail_id': state.currentArticle._id,
        ...
        // 提交喜好数据 喜欢/收藏/评论
        post_favorite_data({ state, rootState }, type, content = '') {
            let params = {
                type,
                'user_id': rootState._id,
                'newsDetail_id': state.currentArticle._id,
            ...
            let res = fetch('post', 'UserOperation', params)
            return res
        },

        // 提交评论数据
        post_Comment_data({ state, rootState }, {type, content}) {
            /* let params = {
                'userid': rootState.userid,
                'id': state.currentArticle.id,
                'datafrom': state.currentArticle.datafrom,
        ...
        // 提交删除评论数据
        post_delete_data({ state, rootState }, commentId) {
            /* let params = {
                'userid': rootState.userid,
                'id': state.currentArticle.id,
                'datafrom': state.currentArticle.datafrom,
            ...
            let params = {
                newsDetailId: state.currentArticle._id,
                commentId
            }
            /* if (type === 'remark') {
                params.remarkid = remarkid
