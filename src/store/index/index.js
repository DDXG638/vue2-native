...
export default {
    namespaced: true,
    state: {
        indexActive: '__all__',          // active的栏目 news_recommend
        indexPage: { '__all__': 1 },       // 记录各个栏目page的对象 news_recommend
        indexLocation: { '__all__': 0 },   // 各个栏目location的对象 news_recommend
        // 栏目数据
        indexColumn: [{
            showclass: '1',
            classid: '10', // 0
            classname: '推荐',
            classpath: '__all__' // news_recommend
        }],
    ...
    actions: {
        ...
        async get_indexColumn_data({ commit, state, dispatch }) {
            ...
            if (data) {
                ...
                res = [...state.indexColumn, ...jsonData]
            }
