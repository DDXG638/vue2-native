    ...
    <transition name='slideIn' mode='in-out'>
        <div id="index">
            ...
            <div class="coverAd" v-if="advertisement">
                <img class="coverOne"  v-if="coverImg" :src="coverImg" @click.stop="$router.push(openPageRouter)">
    ...
    methods: {
        ...
        addvertisement_init() {
            ...
            if (navigator.onLine) {
                ...
                .then(res => {
                    if (res) {
                        this.coverImg = res.data.openPageUrl
                        this.openPageRouter = res.data.openPageRouter
                    }
