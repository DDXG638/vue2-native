        ...
        <div class="container">
            ...
            <div class="loginState">
                ...
                <template v-else>
                    <router-link class="wrapper" :to="{name: 'login'}">
                        <img class="userProfile" src="~@/assets/img/myLogin_1.png">
            ...
            <div class="menu">
                ...
                <router-link class="menu-item" tag="div" :to="{name: 'collect'}">
                    <p class="menu-value">{{collectNum}}</p>
            ...
            <div class="group">
                ...
                <router-link :to="{name: 'QRcode'}">
                    <mt-cell title="开心皮一下"><i class="icon-arrow-right"></i></mt-cell>
                </router-link>
                <!-- 意见反馈 -->
                <router-link :to="{name: 'feedBack'}">
                    <mt-cell title="修改信息"><i class="icon-arrow-right"></i></mt-cell>
                </router-link>
                <!-- 小工具箱 -->
                <router-link :to="{name: 'smallTools'}">
                    <mt-cell title="修改密码"><i class="icon-arrow-right"></i></mt-cell>
                </router-link>
                <!-- 退出登录 -->
...
<style>
#user .loginState{
    background: url('~@/assets/img/myColorp.jpg') no-repeat 50% 0%;
