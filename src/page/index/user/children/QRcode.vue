                ...
                <div class="dl_share">
                    <dl class="dl_share_2">
                        <!--<dd @click="wxShare(1)">
                            ...
                            <span>微信朋友圈</span></dd>-->
                        <dd>
                            <router-link :to="{name: 'gamePuzzle'}">
                                <img src="~@/assets/img/wx_1.png">
                                <span>拼图游戏</span>
                            </router-link>
                        </dd>
                        <dd>
                            <router-link :to="{name: 'my2048'}">
                                <img src="~@/assets/img/wx_2.png">
                                <span>2048</span>
                            </router-link>
                        </dd>
                        <dd @click="qqShare()">
                            <img src="~@/assets/img/wx_3.png">
                            <span>消遣游戏</span>
                        </dd>
                    </dl>
                </div>
                <dl class="base">
                    <dt>Copyright@Aliggua Game Century </dt>
...
#QRcode {
    ...
    .content {
        ...
        .middle {
            ...
            .middle_dt {
                height: 100%;
                background: url('~@/assets/img/cover_game.jpg') no-repeat center;
