    ...
    <div id="detail">
        ...
        <div class="content" :class="{isIOS: $store.state.device == 'ios'}">
            <div class="container" v-swiper:swiperRight='true' v-swiper:all="'blur'">
                ...
                <!-- 热点评论 -->
                <template v-if='currentArticle.comments && currentArticle.comments.length > 0'>
                    <!-- 分割线 -->
                    ...
                    <div class="comment-hot">
                        ...
                        <!-- 评论列表 -->
                        <comment-item layout='topFooter' comment='remark' type='all' v-for='(item,index) in currentArticle.comments' :itemJson='item' :key='index'></comment-item>
                        <!-- 更多评论 -->
...
export default {
    ...
    methods: {
        ...
        async handleTitle() {
            ...
            if (index > -1) {
                this.title = `正好资讯 · ${this.indexColumn[index].classname}`
            }
        },
        // 获取文章
        get_Article() {
