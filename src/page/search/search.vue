        ...
        <div class="search_top">
            <my-header class='header'>
                ...
                <form class='form' slot='mid' @submit.prevent="get_search">
                    ...
                    <input class='form_input' type="search" placeholder="搜资讯，知天下" v-model.trim='key'>
                </form>
                    ...
                    <div class="article">
                        ...
                        <ul v-if='hotJson.length > 0'>
                            <li v-for='(item, index) in hotJson' :key='index'>
                                <router-link :to="`/detail?classid=${item.classid}&id=${item._id}&datafrom=${item.datafrom}`">
...
export default {
    ...
    methods: {
        ...
        get_hot() {
            ...
            .then(res => {
                if (res.code === 0) {
                    this.hotJson = res.data[0].searchs
                } else {
                    this.hotJson = []
                }
                if (res.keyword) {
