<template>
    <section class='comment_item'>
        ...
        <div class='topFooter' v-if="layout === 'topFooter'">
            <div class="top">
                <div class="portrait">
                    <img :src="itemJson.fromUser.headimgurl">
                </div>
        ...
        <div class='leftRight' v-else>
            ...
            <div class="right">
                <div class="top">
                    <span class="name">{{itemJson.fromUser.nickname}}</span>
                    <span class="zan icon-zan" :class="{'active': itemJson.isdz}" @click.stop='addZan'>
                       <span v-if='itemJson.likeNum'> {{itemJson.likeNum}}</span>
                    </span>
                </div>
                <div class="mid">
                    <div class="content_text">
    ...
    methods: {
        ...
        deleteItem() {
            ...
            .then(action => {
                ...
                this.post_delete_data(this.itemJson._id).then(res => {
                    if (res.code === 0) {
